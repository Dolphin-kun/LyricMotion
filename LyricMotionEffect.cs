...
namespace LyricMotion
{
    ...
    internal class LyricMotionEffect : VideoEffectBase
    {
        ...
        [Display(GroupName = "登場退場", Name = "X方向", Description = "X方向")]
        [ToggleSlider]
        public bool Direction_X { get => x; set => Set(ref x, value); }
        bool x = true;

        [Display(GroupName = "登場退場", Name = "Y方向", Description = "Y方向")]
        [ToggleSlider]
        public bool Direction_Y { get => y; set => Set(ref y, value); }
        bool y = true;

        [Display(GroupName = "登場退場", Name = "双方向", Description = "双方向")]
        [ToggleSlider]
        public bool Bidirectional { get => bidirectional; set => Set(ref bidirectional, value); }
        bool bidirectional = true;

        [Display(GroupName = "登場退場", Name = "同一方向", Description = "同一方向")]
        [ToggleSlider]
        ...
        [Display(GroupName = "登場退場", Name = "シード", Description = "シード値")]
        ...
        protected override IEnumerable<IAnimatable> GetAnimatables() => [Distance, Offset];
    }
}
