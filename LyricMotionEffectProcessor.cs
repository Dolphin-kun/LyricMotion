        ...
        public DrawDescription Update(EffectDescription effectDescription)
        {
            ...
            if (isEnter)
            {
                ...
                else
                {
                    ...
                    double customVal = item.CustomEasing.GetValue(currentFrame, playFrames, fps);
                    double progress = customVal / 100.0;
            ...
            if (isExit)
            {
                ...
                else
                {
                    ...
                    double customVal = item.CustomEasing.GetValue(exitFrame, playFrames, fps);
                    double progress = customVal / 100.0;
